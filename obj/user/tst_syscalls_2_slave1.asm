...
_main(void)
{
  ...
  800045:	e8 cd 17 00 00       	call   801817 <sys_allocate_user_mem>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80050d:	e8 22 13 00 00       	call   801834 <__udivdi3>
  ...
  80055b:	52                   	push   %edx
  80055c:	50                   	push   %eax
  80055d:	e8 e2 13 00 00       	call   801944 <__umoddi3>
...
void* sys_sbrk(int increment)
{
  ...
  8017f1:	e8 14 fa ff ff       	call   80120a <syscall>
  8017f6:	83 c4 18             	add    $0x18,%esp
}
  8017f9:	c9                   	leave  
  8017fa:	c3                   	ret    

008017fb <sys_free_user_mem>:
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  80180c:	e8 f9 f9 ff ff       	call   80120a <syscall>
...
00801817 <sys_allocate_user_mem>:
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  801826:	6a 2d                	push   $0x2d
  801828:	e8 dd f9 ff ff       	call   80120a <syscall>
