...
libmain(int argc, char **argv)
{
  ...
  8000e2:	68 58 1b 80 00       	push   $0x801b58
  ...
  800108:	52                   	push   %edx
  800109:	50                   	push   %eax
  80010a:	68 80 1b 80 00       	push   $0x801b80
  ...
  800139:	52                   	push   %edx
  80013a:	50                   	push   %eax
  80013b:	68 a8 1b 80 00       	push   $0x801ba8
  ...
  800156:	50                   	push   %eax
  800157:	68 00 1c 80 00       	push   $0x801c00
  80015c:	e8 01 03 00 00       	call   800462 <cprintf>
  800161:	83 c4 10             	add    $0x10,%esp
		cprintf("**************************************\n");
  800164:	83 ec 0c             	sub    $0xc,%esp
  800167:	68 58 1b 80 00       	push   $0x801b58
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8001c5:	50                   	push   %eax
  8001c6:	68 14 1c 80 00       	push   $0x801c14
  ...
  8001de:	50                   	push   %eax
  8001df:	68 19 1c 80 00       	push   $0x801c19
  ...
  800203:	68 35 1c 80 00       	push   $0x801c35
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800232:	68 38 1c 80 00       	push   $0x801c38
  800237:	6a 26                	push   $0x26
  800239:	68 84 1c 80 00       	push   $0x801c84
  ...
  800307:	68 90 1c 80 00       	push   $0x801c90
  80030c:	6a 3a                	push   $0x3a
  80030e:	68 84 1c 80 00       	push   $0x801c84
  ...
  80037a:	68 e4 1c 80 00       	push   $0x801ce4
  80037f:	6a 44                	push   $0x44
  800381:	68 84 1c 80 00       	push   $0x801c84
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004ff:	e8 24 13 00 00       	call   801828 <__udivdi3>
  ...
  80054d:	52                   	push   %edx
  80054e:	50                   	push   %eax
  80054f:	e8 e4 13 00 00       	call   801938 <__umoddi3>
  800554:	83 c4 10             	add    $0x10,%esp
  800557:	05 54 1f 80 00       	add    $0x801f54,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8006aa:	8b 04 85 78 1f 80 00 	mov    0x801f78(,%eax,4),%eax
  ...
  80078b:	8b 34 9d c0 1d 80 00 	mov    0x801dc0(,%ebx,4),%esi
  800792:	85 f6                	test   %esi,%esi
  800794:	75 19                	jne    8007af <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800796:	53                   	push   %ebx
  800797:	68 65 1f 80 00       	push   $0x801f65
  ...
  8007aa:	e9 5b 02 00 00       	jmp    800a0a <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8007af:	56                   	push   %esi
  8007b0:	68 6e 1f 80 00       	push   $0x801f6e
  ...
  8007db:	75 05                	jne    8007e2 <vprintfmt+0x1a6>
				p = "(null)";
  8007dd:	be 71 1f 80 00       	mov    $0x801f71,%esi
			if (width > 0 && padc != '-')
...
char* str2lower(char *dst, const char *src)
{
  ...
  8011e8:	68 e8 20 80 00       	push   $0x8020e8
  8011ed:	68 3f 01 00 00       	push   $0x13f
  8011f2:	68 0a 21 80 00       	push   $0x80210a
