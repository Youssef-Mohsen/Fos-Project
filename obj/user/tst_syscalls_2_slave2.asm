...
_main(void)
{
  ...
  800058:	68 40 1b 80 00       	push   $0x801b40
  80005d:	6a 0a                	push   $0xa
  80005f:	68 c2 1b 80 00       	push   $0x801bc2
...
libmain(int argc, char **argv)
{
  ...
  8000e5:	68 f8 1b 80 00       	push   $0x801bf8
  ...
  80010b:	52                   	push   %edx
  80010c:	50                   	push   %eax
  80010d:	68 20 1c 80 00       	push   $0x801c20
  ...
  80013c:	52                   	push   %edx
  80013d:	50                   	push   %eax
  80013e:	68 48 1c 80 00       	push   $0x801c48
  ...
  800159:	50                   	push   %eax
  80015a:	68 a0 1c 80 00       	push   $0x801ca0
  80015f:	e8 01 03 00 00       	call   800465 <cprintf>
  800164:	83 c4 10             	add    $0x10,%esp
		cprintf("**************************************\n");
  800167:	83 ec 0c             	sub    $0xc,%esp
  80016a:	68 f8 1b 80 00       	push   $0x801bf8
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8001c8:	50                   	push   %eax
  8001c9:	68 b4 1c 80 00       	push   $0x801cb4
  ...
  8001e1:	50                   	push   %eax
  8001e2:	68 b9 1c 80 00       	push   $0x801cb9
  ...
  800206:	68 d5 1c 80 00       	push   $0x801cd5
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800235:	68 d8 1c 80 00       	push   $0x801cd8
  80023a:	6a 26                	push   $0x26
  80023c:	68 24 1d 80 00       	push   $0x801d24
  ...
  80030a:	68 30 1d 80 00       	push   $0x801d30
  80030f:	6a 3a                	push   $0x3a
  800311:	68 24 1d 80 00       	push   $0x801d24
  ...
  80037d:	68 84 1d 80 00       	push   $0x801d84
  800382:	6a 44                	push   $0x44
  800384:	68 24 1d 80 00       	push   $0x801d24
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800502:	e8 bd 13 00 00       	call   8018c4 <__udivdi3>
  ...
  800550:	52                   	push   %edx
  800551:	50                   	push   %eax
  800552:	e8 7d 14 00 00       	call   8019d4 <__umoddi3>
  800557:	83 c4 10             	add    $0x10,%esp
  80055a:	05 f4 1f 80 00       	add    $0x801ff4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8006ad:	8b 04 85 18 20 80 00 	mov    0x802018(,%eax,4),%eax
  ...
  80078e:	8b 34 9d 60 1e 80 00 	mov    0x801e60(,%ebx,4),%esi
  800795:	85 f6                	test   %esi,%esi
  800797:	75 19                	jne    8007b2 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800799:	53                   	push   %ebx
  80079a:	68 05 20 80 00       	push   $0x802005
  ...
  8007ad:	e9 5b 02 00 00       	jmp    800a0d <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8007b2:	56                   	push   %esi
  8007b3:	68 0e 20 80 00       	push   $0x80200e
  ...
  8007de:	75 05                	jne    8007e5 <vprintfmt+0x1a6>
				p = "(null)";
  8007e0:	be 11 20 80 00       	mov    $0x802011,%esi
			if (width > 0 && padc != '-')
...
char* str2lower(char *dst, const char *src)
{
  ...
  8011eb:	68 88 21 80 00       	push   $0x802188
  8011f0:	68 3f 01 00 00       	push   $0x13f
  8011f5:	68 aa 21 80 00       	push   $0x8021aa
...
struct Env* sys_get_cpu_process()
{
  ...
  801838:	6a 2e                	push   $0x2e
  80183a:	e8 c0 f9 ff ff       	call   8011ff <syscall>
...
void sys_init_queue(struct Env_Queue*queue){
  ...
  80185b:	e8 9f f9 ff ff       	call   8011ff <syscall>
...
void sys_enqueue(struct Env_Queue* queue, struct Env* env){
  ...
  801879:	e8 81 f9 ff ff       	call   8011ff <syscall>
...
struct Env* sys_dequeue(struct Env_Queue* queue)
{
  ...
  801895:	50                   	push   %eax
  801896:	6a 31                	push   $0x31
  801898:	e8 62 f9 ff ff       	call   8011ff <syscall>
...
008018a8 <sys_sched_insert_ready>:
...
void sys_sched_insert_ready( struct Env* env){
  ...
  8018b6:	50                   	push   %eax
  8018b7:	6a 32                	push   $0x32
  8018b9:	e8 41 f9 ff ff       	call   8011ff <syscall>
