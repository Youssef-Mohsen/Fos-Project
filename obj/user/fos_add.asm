	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800387:	e8 0c 15 00 00       	call   801898 <__udivdi3>
  ...
  8003d5:	52                   	push   %edx
  8003d6:	50                   	push   %eax
  8003d7:	e8 cc 15 00 00       	call   8019a8 <__umoddi3>
...
char* str2lower(char *dst, const char *src)
{
  ...
  80107f:	e8 29 06 00 00       	call   8016ad <_panic>
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8016b0:	83 ec 18             	sub    $0x18,%esp
	va_list ap;
	va_start(ap, fmt);
  8016b3:	8d 45 10             	lea    0x10(%ebp),%eax
  8016b6:	83 c0 04             	add    $0x4,%eax
  8016b9:	89 45 f4             	mov    %eax,-0xc(%ebp)
	// Print the panic message
	if (argv0)
  8016bc:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8016c1:	85 c0                	test   %eax,%eax
  8016c3:	74 16                	je     8016db <_panic+0x2e>
		cprintf("%s: ", argv0);
  8016c5:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8016ca:	83 ec 08             	sub    $0x8,%esp
  8016cd:	50                   	push   %eax
  8016ce:	68 f8 1f 80 00       	push   $0x801ff8
  8016d3:	e8 12 ec ff ff       	call   8002ea <cprintf>
  8016d8:	83 c4 10             	add    $0x10,%esp
	cprintf("user panic in %s at %s:%d: ", binaryname, file, line);
  8016db:	a1 00 30 80 00       	mov    0x803000,%eax
  8016e0:	ff 75 0c             	pushl  0xc(%ebp)
  8016e3:	ff 75 08             	pushl  0x8(%ebp)
  8016e6:	50                   	push   %eax
  8016e7:	68 fd 1f 80 00       	push   $0x801ffd
  8016ec:	e8 f9 eb ff ff       	call   8002ea <cprintf>
  ...
  8016fd:	50                   	push   %eax
  8016fe:	e8 7c eb ff ff       	call   80027f <vcprintf>
  801703:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  801706:	83 ec 08             	sub    $0x8,%esp
  801709:	6a 00                	push   $0x0
  80170b:	68 19 20 80 00       	push   $0x802019
  801710:	e8 6a eb ff ff       	call   80027f <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  801718:	e8 eb ea ff ff       	call   800208 <exit>

	// should not return here
	while (1) ;
  80171d:	eb fe                	jmp    80171d <_panic+0x70>

0080171f <CheckWSArrayWithoutLastIndex>:
}
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80172a:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  801730:	8b 45 0c             	mov    0xc(%ebp),%eax
  801733:	39 c2                	cmp    %eax,%edx
  801735:	74 14                	je     80174b <CheckWSArrayWithoutLastIndex+0x2c>
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
  801737:	83 ec 04             	sub    $0x4,%esp
  80173a:	68 1c 20 80 00       	push   $0x80201c
  80173f:	6a 26                	push   $0x26
  801741:	68 68 20 80 00       	push   $0x802068
  801746:	e8 62 ff ff ff       	call   8016ad <_panic>
	}
	int expectedNumOfEmptyLocs = 0;
  80174b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int e = 0; e < arraySize; e++) {
  801752:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801759:	e9 c5 00 00 00       	jmp    801823 <CheckWSArrayWithoutLastIndex+0x104>
  ...
  8017e6:	75 09                	jne    8017f1 <CheckWSArrayWithoutLastIndex+0xd2>
						== expectedPages[e]) {
					found = 1;
  8017e8:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
					break;
  8017ef:	eb 15                	jmp    801806 <CheckWSArrayWithoutLastIndex+0xe7>
		if (expectedPages[e] == 0) {
			expectedNumOfEmptyLocs++;
			continue;
		}
  ...
  801804:	77 85                	ja     80178b <CheckWSArrayWithoutLastIndex+0x6c>
					found = 1;
					break;
				}
			}
		...
		if (!found)
  801806:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  80180a:	75 14                	jne    801820 <CheckWSArrayWithoutLastIndex+0x101>
			panic(
  80180c:	83 ec 04             	sub    $0x4,%esp
  80180f:	68 74 20 80 00       	push   $0x802074
  801814:	6a 3a                	push   $0x3a
  801816:	68 68 20 80 00       	push   $0x802068
  80181b:	e8 8d fe ff ff       	call   8016ad <_panic>
	if (arraySize != myEnv->page_WS_max_size)
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
	}
	int expectedNumOfEmptyLocs = 0;
	for (int e = 0; e < arraySize; e++) {
  801820:	ff 45 f0             	incl   -0x10(%ebp)
  801823:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801826:	3b 45 0c             	cmp    0xc(%ebp),%eax
  801829:	0f 8c 2f ff ff ff    	jl     80175e <CheckWSArrayWithoutLastIndex+0x3f>
		}
		if (!found)
			panic(
  ...
  80182f:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801836:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  80183d:	eb 26                	jmp    801865 <CheckWSArrayWithoutLastIndex+0x146>
		if (myEnv->__uptr_pws[w].empty == 1) {
  80183f:	a1 04 30 80 00       	mov    0x803004,%eax
  801844:	8b 88 7c 05 00 00    	mov    0x57c(%eax),%ecx
  80184a:	8b 55 e0             	mov    -0x20(%ebp),%edx
  80184d:	89 d0                	mov    %edx,%eax
  80184f:	01 c0                	add    %eax,%eax
  801851:	01 d0                	add    %edx,%eax
  801853:	c1 e0 03             	shl    $0x3,%eax
  801856:	01 c8                	add    %ecx,%eax
  801858:	8a 40 04             	mov    0x4(%eax),%al
  80185b:	3c 01                	cmp    $0x1,%al
  80185d:	75 03                	jne    801862 <CheckWSArrayWithoutLastIndex+0x143>
			actualNumOfEmptyLocs++;
  80185f:	ff 45 e4             	incl   -0x1c(%ebp)
		if (!found)
			panic(
					"PAGE WS entry checking failed... trace it by printing page WS before & after fault");
	}
	int actualNumOfEmptyLocs = 0;
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801862:	ff 45 e0             	incl   -0x20(%ebp)
  801865:	a1 04 30 80 00       	mov    0x803004,%eax
  80186a:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
  801870:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801873:	39 c2                	cmp    %eax,%edx
  801875:	77 c8                	ja     80183f <CheckWSArrayWithoutLastIndex+0x120>
		if (myEnv->__uptr_pws[w].empty == 1) {
			actualNumOfEmptyLocs++;
		}
	}
  ...
  80187a:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
  80187d:	74 14                	je     801893 <CheckWSArrayWithoutLastIndex+0x174>
		panic(
  80187f:	83 ec 04             	sub    $0x4,%esp
  801882:	68 c8 20 80 00       	push   $0x8020c8
  801887:	6a 44                	push   $0x44
  801889:	68 68 20 80 00       	push   $0x802068
  80188e:	e8 1a fe ff ff       	call   8016ad <_panic>
