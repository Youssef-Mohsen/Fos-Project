...
libmain(int argc, char **argv)
{
  ...
  8000f1:	68 4c 1b 80 00       	push   $0x801b4c
  ...
  800117:	52                   	push   %edx
  800118:	50                   	push   %eax
  800119:	68 74 1b 80 00       	push   $0x801b74
  ...
  800148:	52                   	push   %edx
  800149:	50                   	push   %eax
  80014a:	68 9c 1b 80 00       	push   $0x801b9c
  ...
  800165:	50                   	push   %eax
  800166:	68 f4 1b 80 00       	push   $0x801bf4
  80016b:	e8 01 03 00 00       	call   800471 <cprintf>
  800170:	83 c4 10             	add    $0x10,%esp
		cprintf("**************************************\n");
  800173:	83 ec 0c             	sub    $0xc,%esp
  800176:	68 4c 1b 80 00       	push   $0x801b4c
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8001d4:	50                   	push   %eax
  8001d5:	68 08 1c 80 00       	push   $0x801c08
  ...
  8001ed:	50                   	push   %eax
  8001ee:	68 0d 1c 80 00       	push   $0x801c0d
  ...
  800212:	68 29 1c 80 00       	push   $0x801c29
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800241:	68 2c 1c 80 00       	push   $0x801c2c
  800246:	6a 26                	push   $0x26
  800248:	68 78 1c 80 00       	push   $0x801c78
  ...
  800316:	68 84 1c 80 00       	push   $0x801c84
  80031b:	6a 3a                	push   $0x3a
  80031d:	68 78 1c 80 00       	push   $0x801c78
  ...
  800389:	68 d8 1c 80 00       	push   $0x801cd8
  80038e:	6a 44                	push   $0x44
  800390:	68 78 1c 80 00       	push   $0x801c78
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80050e:	e8 21 13 00 00       	call   801834 <__udivdi3>
  ...
  80055c:	52                   	push   %edx
  80055d:	50                   	push   %eax
  80055e:	e8 e1 13 00 00       	call   801944 <__umoddi3>
...
void* sys_sbrk(int increment)
{
  ...
  8017ef:	50                   	push   %eax
  8017f0:	6a 2b                	push   $0x2b
  8017f2:	e8 14 fa ff ff       	call   80120b <syscall>
  8017f7:	83 c4 18             	add    $0x18,%esp
}
  8017fa:	c9                   	leave  
  8017fb:	c3                   	ret    

008017fc <sys_free_user_mem>:
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  80180d:	e8 f9 f9 ff ff       	call   80120b <syscall>
...
00801818 <sys_allocate_user_mem>:
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  801827:	6a 2d                	push   $0x2d
  801829:	e8 dd f9 ff ff       	call   80120b <syscall>
