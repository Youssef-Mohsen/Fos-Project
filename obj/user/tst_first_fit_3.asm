...
libmain(int argc, char **argv)
{
  ...
  8000a2:	a3 04 30 80 00       	mov    %eax,0x803004
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8001c2:	74 16                	je     8001da <_panic+0x2e>
		cprintf("%s: ", argv0);
  8001c4:	a1 24 30 80 00       	mov    0x803024,%eax
  ...
  8001da:	a1 00 30 80 00       	mov    0x803000,%eax
...
static void putch(int ch, struct printbuf *b) {
  ...
  8003c0:	a0 08 30 80 00       	mov    0x803008,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800432:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName);
  800435:	a0 08 30 80 00       	mov    0x803008,%al
  ...
  800457:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  80045a:	c6 05 08 30 80 00 00 	movb   $0x0,0x803008
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  80046c:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  80046f:	c6 05 08 30 80 00 01 	movb   $0x1,0x803008
	va_start(ap, fmt);
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8009da:	eb 35                	jmp    800a11 <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  8009dc:	c6 05 08 30 80 00 00 	movb   $0x0,0x803008
			break;
  8009e3:	eb 2c                	jmp    800a11 <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  8009e5:	c6 05 08 30 80 00 01 	movb   $0x1,0x803008
			break;
