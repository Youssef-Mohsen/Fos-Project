...
void _main(void)
{
  ...
  800049:	6a 1f                	push   $0x1f
  80004b:	68 d1 1a 80 00       	push   $0x801ad1
...
libmain(int argc, char **argv)
{
  ...
  8000df:	68 00 1b 80 00       	push   $0x801b00
  ...
  800105:	52                   	push   %edx
  800106:	50                   	push   %eax
  800107:	68 28 1b 80 00       	push   $0x801b28
  ...
  800136:	52                   	push   %edx
  800137:	50                   	push   %eax
  800138:	68 50 1b 80 00       	push   $0x801b50
  ...
  800153:	50                   	push   %eax
  800154:	68 a8 1b 80 00       	push   $0x801ba8
  800159:	e8 01 03 00 00       	call   80045f <cprintf>
  80015e:	83 c4 10             	add    $0x10,%esp
		cprintf("**************************************\n");
  800161:	83 ec 0c             	sub    $0xc,%esp
  800164:	68 00 1b 80 00       	push   $0x801b00
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8001c2:	50                   	push   %eax
  8001c3:	68 bc 1b 80 00       	push   $0x801bbc
  ...
  8001db:	50                   	push   %eax
  8001dc:	68 c1 1b 80 00       	push   $0x801bc1
  ...
  800200:	68 dd 1b 80 00       	push   $0x801bdd
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80022f:	68 e0 1b 80 00       	push   $0x801be0
  800234:	6a 26                	push   $0x26
  800236:	68 2c 1c 80 00       	push   $0x801c2c
  ...
  800304:	68 38 1c 80 00       	push   $0x801c38
  800309:	6a 3a                	push   $0x3a
  80030b:	68 2c 1c 80 00       	push   $0x801c2c
  ...
  800377:	68 8c 1c 80 00       	push   $0x801c8c
  80037c:	6a 44                	push   $0x44
  80037e:	68 2c 1c 80 00       	push   $0x801c2c
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004fc:	e8 23 13 00 00       	call   801824 <__udivdi3>
  ...
  80054a:	52                   	push   %edx
  80054b:	50                   	push   %eax
  80054c:	e8 e3 13 00 00       	call   801934 <__umoddi3>
  800551:	83 c4 10             	add    $0x10,%esp
  800554:	05 f4 1e 80 00       	add    $0x801ef4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8006a7:	8b 04 85 18 1f 80 00 	mov    0x801f18(,%eax,4),%eax
  ...
  800788:	8b 34 9d 60 1d 80 00 	mov    0x801d60(,%ebx,4),%esi
  80078f:	85 f6                	test   %esi,%esi
  800791:	75 19                	jne    8007ac <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800793:	53                   	push   %ebx
  800794:	68 05 1f 80 00       	push   $0x801f05
  ...
  8007a7:	e9 5b 02 00 00       	jmp    800a07 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8007ac:	56                   	push   %esi
  8007ad:	68 0e 1f 80 00       	push   $0x801f0e
  ...
  8007d8:	75 05                	jne    8007df <vprintfmt+0x1a6>
				p = "(null)";
  8007da:	be 11 1f 80 00       	mov    $0x801f11,%esi
			if (width > 0 && padc != '-')
...
char* str2lower(char *dst, const char *src)
{
  ...
  8011e5:	68 88 20 80 00       	push   $0x802088
  8011ea:	68 3f 01 00 00       	push   $0x13f
  8011ef:	68 aa 20 80 00       	push   $0x8020aa
...
void* sys_sbrk(int increment)
{
  ...
  8017dd:	50                   	push   %eax
  8017de:	6a 2b                	push   $0x2b
  8017e0:	e8 14 fa ff ff       	call   8011f9 <syscall>
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8017fb:	e8 f9 f9 ff ff       	call   8011f9 <syscall>
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  801817:	e8 dd f9 ff ff       	call   8011f9 <syscall>
