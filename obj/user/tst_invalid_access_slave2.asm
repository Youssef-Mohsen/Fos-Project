...
libmain(int argc, char **argv)
{
  ...
  8000e3:	68 54 1b 80 00       	push   $0x801b54
  ...
  800109:	52                   	push   %edx
  80010a:	50                   	push   %eax
  80010b:	68 7c 1b 80 00       	push   $0x801b7c
  ...
  80013a:	52                   	push   %edx
  80013b:	50                   	push   %eax
  80013c:	68 a4 1b 80 00       	push   $0x801ba4
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8001c6:	50                   	push   %eax
  8001c7:	68 10 1c 80 00       	push   $0x801c10
  ...
  8001df:	50                   	push   %eax
  8001e0:	68 15 1c 80 00       	push   $0x801c15
  ...
  800204:	68 31 1c 80 00       	push   $0x801c31
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80023a:	68 80 1c 80 00       	push   $0x801c80
  ...
  800308:	68 8c 1c 80 00       	push   $0x801c8c
  80030d:	6a 3a                	push   $0x3a
  80030f:	68 80 1c 80 00       	push   $0x801c80
  ...
  80037b:	68 e0 1c 80 00       	push   $0x801ce0
  800380:	6a 44                	push   $0x44
  800382:	68 80 1c 80 00       	push   $0x801c80
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800500:	e8 23 13 00 00       	call   801828 <__udivdi3>
  ...
  80054e:	52                   	push   %edx
  80054f:	50                   	push   %eax
  800550:	e8 e3 13 00 00       	call   801938 <__umoddi3>
  800555:	83 c4 10             	add    $0x10,%esp
  800558:	05 54 1f 80 00       	add    $0x801f54,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8006ab:	8b 04 85 78 1f 80 00 	mov    0x801f78(,%eax,4),%eax
  ...
  80078c:	8b 34 9d c0 1d 80 00 	mov    0x801dc0(,%ebx,4),%esi
  800793:	85 f6                	test   %esi,%esi
  800795:	75 19                	jne    8007b0 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800797:	53                   	push   %ebx
  800798:	68 65 1f 80 00       	push   $0x801f65
  ...
  8007ab:	e9 5b 02 00 00       	jmp    800a0b <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8007b0:	56                   	push   %esi
  8007b1:	68 6e 1f 80 00       	push   $0x801f6e
  ...
  8007dc:	75 05                	jne    8007e3 <vprintfmt+0x1a6>
				p = "(null)";
  8007de:	be 71 1f 80 00       	mov    $0x801f71,%esi
			if (width > 0 && padc != '-')
...
char* str2lower(char *dst, const char *src)
{
  ...
  8011e9:	68 e8 20 80 00       	push   $0x8020e8
  8011ee:	68 3f 01 00 00       	push   $0x13f
  8011f3:	68 0a 21 80 00       	push   $0x80210a
