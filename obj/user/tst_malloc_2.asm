...
void _main(void)
{
  ...
  800046:	6a 27                	push   $0x27
  800048:	68 d1 1a 80 00       	push   $0x801ad1
...
libmain(int argc, char **argv)
{
  ...
  800095:	a3 20 30 80 00       	mov    %eax,0x803020
  ...
  8000ae:	a3 1c 30 80 00       	mov    %eax,0x80301c
  ...
  8000be:	a3 1c 30 80 00       	mov    %eax,0x80301c
  ...
  8000dc:	68 00 1b 80 00       	push   $0x801b00
  ...
  800102:	52                   	push   %edx
  800103:	50                   	push   %eax
  800104:	68 28 1b 80 00       	push   $0x801b28
  ...
  800133:	52                   	push   %edx
  800134:	50                   	push   %eax
  800135:	68 50 1b 80 00       	push   $0x801b50
  ...
  800150:	50                   	push   %eax
  800151:	68 a8 1b 80 00       	push   $0x801ba8
  800156:	e8 01 03 00 00       	call   80045c <cprintf>
  80015b:	83 c4 10             	add    $0x10,%esp
		cprintf("**************************************\n");
  80015e:	83 ec 0c             	sub    $0xc,%esp
  800161:	68 00 1b 80 00       	push   $0x801b00
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8001fd:	68 dd 1b 80 00       	push   $0x801bdd
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80022c:	68 e0 1b 80 00       	push   $0x801be0
  800231:	6a 26                	push   $0x26
  800233:	68 2c 1c 80 00       	push   $0x801c2c
  ...
  800301:	68 38 1c 80 00       	push   $0x801c38
  800306:	6a 3a                	push   $0x3a
  800308:	68 2c 1c 80 00       	push   $0x801c2c
  ...
  800331:	a1 20 30 80 00       	mov    0x803020,%eax
  ...
  800357:	a1 20 30 80 00       	mov    0x803020,%eax
  ...
  800374:	68 8c 1c 80 00       	push   $0x801c8c
  800379:	6a 44                	push   $0x44
  80037b:	68 2c 1c 80 00       	push   $0x801c2c
...
static void putch(int ch, struct printbuf *b) {
  ...
  8003b3:	a0 40 30 80 00       	mov    0x803040,%al
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800425:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName);
  800428:	a0 40 30 80 00       	mov    0x803040,%al
  ...
  80044a:	83 c4 10             	add    $0x10,%esp
	...
	printProgName = 0;
  80044d:	c6 05 40 30 80 00 00 	movb   $0x0,0x803040
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  80045f:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  800462:	c6 05 40 30 80 00 01 	movb   $0x1,0x803040
	va_start(ap, fmt);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004f9:	e8 22 13 00 00       	call   801820 <__udivdi3>
  ...
  800547:	52                   	push   %edx
  800548:	50                   	push   %eax
  800549:	e8 e2 13 00 00       	call   801930 <__umoddi3>
  80054e:	83 c4 10             	add    $0x10,%esp
  800551:	05 f4 1e 80 00       	add    $0x801ef4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8006a4:	8b 04 85 18 1f 80 00 	mov    0x801f18(,%eax,4),%eax
  ...
  800785:	8b 34 9d 60 1d 80 00 	mov    0x801d60(,%ebx,4),%esi
  80078c:	85 f6                	test   %esi,%esi
  80078e:	75 19                	jne    8007a9 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800790:	53                   	push   %ebx
  800791:	68 05 1f 80 00       	push   $0x801f05
  ...
  8007a4:	e9 5b 02 00 00       	jmp    800a04 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8007a9:	56                   	push   %esi
  8007aa:	68 0e 1f 80 00       	push   $0x801f0e
  ...
  8007d5:	75 05                	jne    8007dc <vprintfmt+0x1a6>
				p = "(null)";
  8007d7:	be 11 1f 80 00       	mov    $0x801f11,%esi
			if (width > 0 && padc != '-')
  ...
  8009cd:	eb 35                	jmp    800a04 <vprintfmt+0x3ce>
		...
		case '~':
			printProgName = 0;
  8009cf:	c6 05 40 30 80 00 00 	movb   $0x0,0x803040
			break;
  8009d6:	eb 2c                	jmp    800a04 <vprintfmt+0x3ce>
		// Print Program Name & UD
		case '@':
			printProgName = 1;
  8009d8:	c6 05 40 30 80 00 01 	movb   $0x1,0x803040
			break;
...
char* str2lower(char *dst, const char *src)
{
  ...
  8011e2:	68 88 20 80 00       	push   $0x802088
  8011e7:	68 3f 01 00 00       	push   $0x13f
  8011ec:	68 aa 20 80 00       	push   $0x8020aa
...
void* sys_sbrk(int increment)
{
  ...
  8017da:	50                   	push   %eax
  8017db:	6a 2b                	push   $0x2b
  8017dd:	e8 14 fa ff ff       	call   8011f6 <syscall>
  8017e2:	83 c4 18             	add    $0x18,%esp
}
  8017e5:	c9                   	leave  
  8017e6:	c3                   	ret    

008017e7 <sys_free_user_mem>:
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8017f8:	e8 f9 f9 ff ff       	call   8011f6 <syscall>
...
00801803 <sys_allocate_user_mem>:
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  801814:	e8 dd f9 ff ff       	call   8011f6 <syscall>
