...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80162e:	89 45 f4             	mov    %eax,-0xc(%ebp)
	...
	if (argv0)
  801631:	a1 24 30 80 00       	mov    0x803024,%eax
  801636:	85 c0                	test   %eax,%eax
  801638:	74 16                	je     801650 <_panic+0x2e>
		cprintf("%s: ", argv0);
  80163a:	a1 24 30 80 00       	mov    0x803024,%eax
  ...
  801650:	a1 00 30 80 00       	mov    0x803000,%eax
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  801700:	a1 04 30 80 00       	mov    0x803004,%eax
